...
impl super::Renderer {
    ...
    fn show_debug_tab(&mut self, ui: &mut egui::Ui) {
        ...
        ui.group(|ui| {
            ...
            ui.checkbox(&mut self.show_foil_electron_deficiency, "Show Foil Electron Deficiency/Excess");
            ui.checkbox(&mut self.show_metal_electron_deficiency, "Show Metal Electron Deficiency/Excess");
        });
    }
    ...
    fn show_diagnostics_tab(&mut self, ui: &mut egui::Ui) {
        ...
        ui.group(|ui| {
            ...
            if let Some(diagnostic) = &self.transference_number_diagnostic {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.label(format!("({:.3}, {:.3})", diagnostic.drift_direction.x, diagnostic.drift_direction.y));
                });
                ui.horizontal(|ui| {
                ...
                ui.add(egui::ProgressBar::new(diagnostic.transference_number)
        ...
        ui.group(|ui| {
            ...
            let lithium_count = self.bodies.iter().filter(|b| b.species == crate::body::Species::LithiumIon).count();
            let anion_count = self.bodies.iter().filter(|b| b.species == crate::body::Species::ElectrolyteAnion).count();
            let foil_count = self.bodies.iter().filter(|b| b.species == crate::body::Species::FoilMetal).count();
