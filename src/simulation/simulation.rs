...
use crate::diagnostics::TransferenceDiagnostics;
...
pub struct Simulation {
    ...
    pub transference_diagnostics: TransferenceDiagnostics,
}
...
impl Simulation {
    pub fn new() -> Self {
        ...
        let sim = Self {
            ...
            transference_diagnostics: TransferenceDiagnostics::new(1),
        };
