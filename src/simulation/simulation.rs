...
impl Simulation {
    ...
    pub fn perform_sei_formation(&mut self) {
        ...
        let conversions: Vec<SeiCandidate> = self
            ...
            .filter_map(|(i, body)| {
                let species = match body.species {
                    Species::EC | Species::DMC | Species::VC | Species::FEC | Species::EMC => body.species,
                    _ => return None,
                };
                ...
                for &neighbor_idx in &neighbors {
                    ...
                    let threshold = sei_charge_threshold_for_species(species, &config_snapshot);
        ...
        for candidate in conversions {
            ...
            if let Some((metal, solvent)) = two_body_indices_mut(&mut self.bodies, metal_idx, solvent_idx) {
                let threshold = sei_charge_threshold_for_species(candidate.solvent_species, &self.config);
