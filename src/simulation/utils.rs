...
mod tests {
    ...
    fn test_lithium_metal_max_electrons() {
        ...
        let mut lithium_metal = Body::new(
            Vec2::zero(),
            Vec2::zero(),
            1.0,
            1.0,
        ...
        for _ in 0..crate::config::LITHIUM_METAL_MAX_ELECTRONS {
            lithium_metal.electrons.push(Electron {
                rel_pos: Vec2::zero(),
                vel: Vec2::zero(),
            });
        }
        ...
        let deficient_lithium = Body::new(
            Vec2::new(1.0, 0.0),
            Vec2::zero(),
            1.0,
            1.0,
        ...
        let mut another_max_lithium = Body::new(
            Vec2::new(2.0, 0.0),
            Vec2::zero(),
            1.0,
            1.0,
        ...
        for _ in 0..crate::config::LITHIUM_METAL_MAX_ELECTRONS {
            another_max_lithium.electrons.push(Electron {
                rel_pos: Vec2::zero(),
                vel: Vec2::zero(),
            });
        }
